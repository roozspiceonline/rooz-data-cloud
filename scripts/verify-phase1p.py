...
need("apps/api/migrations/versions/20260809_0015_request_queues.py", "ENABLE ROW LEVEL SECURITY", "rdc_request_queue_org", "request_queue_transition_immutable", "request_queue_enqueue_receipt_immutable", "Request Queue request identity is immutable", "request_queues_tenant_update", "request_queues_execution_worker_update", "request_queue_requests_execution_worker_update", "request_queue_transitions_execution_worker_insert", "lease.work_kind = 'RUN_START'", "enforce_audit_event_tenancy", "audit_event_immutable")
...
need("apps/api/tests/test_phase1p_postgres_integration.py", "simultaneous_claim", "idempotent_enqueue_emits_one_tenant_bound_audit_event", "tenancy_trigger", "request_identity_and_enqueue_receipts_are_immutable", "expired_claim_requeues", "retry_exhaustion", "audit_events_reject_cross_tenant_projects_and_mutation", "queue_pagination_is_stable_at_equal_timestamps", "queue_and_transition_rls_hide_other_tenant", "worker_completion_emits_tenant_bound_audit_event", "cross_tenant_resolver", "stale_claim_token")
